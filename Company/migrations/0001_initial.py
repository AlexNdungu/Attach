    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='company_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='JobLevel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_decr', ckeditor.fields.RichTextField()),
                ('update', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_job', to='Company.companyprofile')),
                ('job_level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Company.joblevel')),
                ('job_location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Company.joblocation')),
            ],
        ),
        migrations.CreateModel(
